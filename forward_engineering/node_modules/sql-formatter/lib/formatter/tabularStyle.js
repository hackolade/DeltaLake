...
function isTabularToken(token) {
  return (0, _token.isLogicalOperator)(token) || token.type === _token.TokenType.RESERVED_DEPENDENT_CLAUSE || token.type === _token.TokenType.RESERVED_COMMAND || token.type === _token.TokenType.RESERVED_SELECT || token.type === _token.TokenType.RESERVED_SET_OPERATION || token.type === _token.TokenType.RESERVED_JOIN;
}
