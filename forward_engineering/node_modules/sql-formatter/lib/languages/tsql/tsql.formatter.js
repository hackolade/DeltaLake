...
var _tsql = require("./tsql.functions");

var _tsql2 = require("./tsql.keywords");
...
'{CROSS | OUTER} APPLY']);
var reservedPhrases = ['ON DELETE', 'ON UPDATE']; // https://docs.microsoft.com/en-us/sql/t-sql/language-reference?view=sql-server-ver15
  ...
  _createClass(TSqlFormatter, [{
    ...
    value: function tokenizer() {
      return new _Tokenizer["default"]({
        ...
        reservedKeywords: _tsql2.keywords,
        reservedFunctionNames: _tsql.functions,
        stringTypes: [{
          quote: "''",
          prefixes: ['N']
        }],
