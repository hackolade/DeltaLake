...
'WITH', 'FROM', 'WHERE', 'GROUP BY', 'HAVING', 'WINDOW', 'ORDER BY', 'SORT BY', 'CLUSTER BY', 'DISTRIBUTE BY', 'LIMIT', // Data manipulation
// - insert:
...
var reservedPhrases = ['ON DELETE', 'ON UPDATE', 'CURRENT ROW']; // http://spark.apache.org/docs/latest/sql-programming-guide.html
