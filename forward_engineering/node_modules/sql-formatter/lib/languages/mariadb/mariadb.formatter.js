...
'WITH [RECURSIVE]', 'FROM', 'WHERE', 'GROUP BY', 'HAVING', 'ORDER BY', 'LIMIT', 'OFFSET', 'FETCH {FIRST | NEXT}', // Data manipulation
// - insert:
...
'STRAIGHT_JOIN']);
var reservedPhrases = ['ON DELETE', 'ON UPDATE', 'CHARACTER SET']; // For reference: https://mariadb.com/kb/en/sql-statements-structure/
