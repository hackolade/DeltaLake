...
'WITH', 'FROM', 'WHERE', 'GROUP BY', 'HAVING', 'ORDER BY [INPUT SEQUENCE]', 'FETCH FIRST', // Data modification
// - insert:
...
var reservedPhrases = ['ON DELETE', 'ON UPDATE']; // https://www.ibm.com/support/knowledgecenter/en/ssw_ibm_i_72/db2/rbafzintro.htm
