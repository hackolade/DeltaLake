...
const getAddCheckConstraintsScriptsDtosFromTable = (ddlProvider) => (fullTableName, collection) => {
    ...
    return newCheckConstraints
        .filter((newCheckConstraint) => {
            ...
            const oldCorrespondingConstraint = oldCheckConstraints.find(oldCheckConstraint => (
                oldCheckConstraint.GUID === newCheckConstraint.GUID
            ));
            ...
            return oldCorrespondingConstraint.chkConstrName !== newCheckConstraint.chkConstrName
...
const getRemoveCheckConstraintsScriptsDtosFromTable = (ddlProvider) => (fullTableName, collection) => {
    ...
    return oldCheckConstraints
        .filter((oldCheckConstraint) => {
            ...
            const newCorrespondingConstraint = newCheckConstraints.find(newCheckConstraint => (
                newCheckConstraint.GUID === oldCheckConstraint.GUID
            ));
            ...
            return newCorrespondingConstraint.chkConstrName !== oldCheckConstraint.chkConstrName
...
const getModifyCheckConstraintsScriptDtos = (ddlProvider) => (fullTableName, collection) => {
    const removeCheckConstraintsScriptDtosFromTable = getRemoveCheckConstraintsScriptsDtosFromTable(ddlProvider)(fullTableName, collection);
    const addCheckConstraintsScriptDtosFromTable = getAddCheckConstraintsScriptsDtosFromTable(ddlProvider)(fullTableName, collection);
