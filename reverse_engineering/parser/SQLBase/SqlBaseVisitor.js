...
class SqlBaseVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by SqlBaseParser#identityOptions.
	visitIdentityOptions(ctx) {
		return this.visitChildren(ctx);
	}

	// Visit a parse tree produced by SqlBaseParser#startWith.
	visitStartWith(ctx) {
		return this.visitChildren(ctx);
	}

	// Visit a parse tree produced by SqlBaseParser#incrementBy.
