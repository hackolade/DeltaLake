...
SqlBaseVisitor.prototype = Object.create(
...
SqlBaseVisitor.prototype.visitErrorCapturingMultiUnitsInterval = function (
  ctx
) {
  return this.visitChildren(ctx);
};
...
SqlBaseVisitor.prototype.visitErrorCapturingUnitToUnitInterval = function (
  ctx
) {
  return this.visitChildren(ctx);
};
...
SqlBaseVisitor.prototype.visitQualifiedColTypeWithPositionList = function (
  ctx
) {
  return this.visitChildren(ctx);
};
