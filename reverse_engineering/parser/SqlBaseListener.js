...
SqlBaseListener.prototype.enterAnalyzeTables = function(ctx) {
};

// Exit a parse tree produced by SqlBaseParser#analyzeTables.
SqlBaseListener.prototype.exitAnalyzeTables = function(ctx) {
};
...
SqlBaseListener.prototype.enterShowTableExtended = function(ctx) {
};

// Exit a parse tree produced by SqlBaseParser#showTableExtended.
SqlBaseListener.prototype.exitShowTableExtended = function(ctx) {
};
...
SqlBaseListener.prototype.enterConfigValue = function(ctx) {
};

// Exit a parse tree produced by SqlBaseParser#configValue.
SqlBaseListener.prototype.exitConfigValue = function(ctx) {
};
...
SqlBaseListener.prototype.enterGroupByClause = function(ctx) {
};

// Exit a parse tree produced by SqlBaseParser#groupByClause.
SqlBaseListener.prototype.exitGroupByClause = function(ctx) {
};


// Enter a parse tree produced by SqlBaseParser#groupingAnalytics.
SqlBaseListener.prototype.enterGroupingAnalytics = function(ctx) {
};

// Exit a parse tree produced by SqlBaseParser#groupingAnalytics.
SqlBaseListener.prototype.exitGroupingAnalytics = function(ctx) {
};
...
SqlBaseListener.prototype.enterPartitionFieldList = function(ctx) {
};

// Exit a parse tree produced by SqlBaseParser#partitionFieldList.
SqlBaseListener.prototype.exitPartitionFieldList = function(ctx) {
};


// Enter a parse tree produced by SqlBaseParser#partitionTransform.
SqlBaseListener.prototype.enterPartitionTransform = function(ctx) {
};

// Exit a parse tree produced by SqlBaseParser#partitionTransform.
SqlBaseListener.prototype.exitPartitionTransform = function(ctx) {
};


// Enter a parse tree produced by SqlBaseParser#partitionColumn.
SqlBaseListener.prototype.enterPartitionColumn = function(ctx) {
};

// Exit a parse tree produced by SqlBaseParser#partitionColumn.
SqlBaseListener.prototype.exitPartitionColumn = function(ctx) {
};
