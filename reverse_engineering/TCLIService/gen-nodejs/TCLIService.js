...
TCLIService_GetQueryId_args = function(args) {
  this.req = null;
  if (args) {
    if (args.req !== undefined) {
      this.req = args.req;
...
TCLIService_GetQueryId_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
TCLIService_SetClientInfo_args = function(args) {
  this.req = null;
  if (args) {
    if (args.req !== undefined) {
      this.req = args.req;
...
TCLIService_SetClientInfo_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
TCLIServiceProcessor.prototype.process_GetPrimaryKeys = function(seqid, input, output) {
  ...
  this._handler.GetPrimaryKeys(args.req, function (err, result) {
    var result = new TCLIService_GetPrimaryKeys_result((err != null ? err : {success: result}));
...
TCLIServiceProcessor.prototype.process_GetCrossReference = function(seqid, input, output) {
  ...
  this._handler.GetCrossReference(args.req, function (err, result) {
    var result = new TCLIService_GetCrossReference_result((err != null ? err : {success: result}));
...
TCLIServiceProcessor.prototype.process_GetQueryId = function(seqid, input, output) {
  ...
  this._handler.GetQueryId(args.req, function (err, result) {
    var result = new TCLIService_GetQueryId_result((err != null ? err : {success: result}));
...
TCLIServiceProcessor.prototype.process_SetClientInfo = function(seqid, input, output) {
  ...
  this._handler.SetClientInfo(args.req, function (err, result) {
    var result = new TCLIService_SetClientInfo_result((err != null ? err : {success: result}));
