...
TRowSet = module.exports.TRowSet = function(args) {
  ...
  if (args) {
    ...
    if (args.binaryColumns !== undefined) {
      this.binaryColumns = args.binaryColumns;
    }
    if (args.columnCount !== undefined) {
...
TRowSet.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.binaryColumns = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
TRowSet.prototype.write = function(output) {
  ...
  if (this.binaryColumns !== null && this.binaryColumns !== undefined) {
    ...
    output.writeString(this.binaryColumns);
    output.writeFieldEnd();
  }
...
TSetClientInfoReq = module.exports.TSetClientInfoReq = function(args) {
  this.sessionHandle = null;
  this.configuration = null;
  if (args) {
    if (args.sessionHandle !== undefined) {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i167 = 0; _i167 < _size162; ++_i167)
        {
          ...
          this.configuration[key168] = val169;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TSetClientInfoReq.prototype.write = function(output) {
  ...
  if (this.configuration !== null && this.configuration !== undefined) {
    ...
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRING, Thrift.objectLength(this.configuration));
    for (var kiter170 in this.configuration)
    {
      if (this.configuration.hasOwnProperty(kiter170))
      {
        var viter171 = this.configuration[kiter170];
...
TSetClientInfoResp = module.exports.TSetClientInfoResp = function(args) {
  this.status = null;
  if (args) {
    if (args.status !== undefined) {
      this.status = args.status;
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i177 = 0; _i177 < _size172; ++_i177)
        {
          ...
          this.confOverlay[key178] = val179;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TExecuteStatementReq.prototype.write = function(output) {
  ...
  if (this.confOverlay !== null && this.confOverlay !== undefined) {
    ...
    for (var kiter180 in this.confOverlay)
    {
      if (this.confOverlay.hasOwnProperty(kiter180))
      {
        var viter181 = this.confOverlay[kiter180];
...
TGetTablesReq.prototype.write = function(output) {
  ...
  if (this.tableTypes !== null && this.tableTypes !== undefined) {
    ...
    for (var iter189 in this.tableTypes)
    {
      if (this.tableTypes.hasOwnProperty(iter189))
      {
        iter189 = this.tableTypes[iter189];
...
TProgressUpdateResp = module.exports.TProgressUpdateResp = function(args) {
  ...
  this.startTime = null;
  if (args) {
    if (args.headerNames !== undefined) {
      this.headerNames = args.headerNames;
    }
    if (args.rows !== undefined) {
      this.rows = args.rows;
    }
    if (args.progressedPercentage !== undefined) {
      this.progressedPercentage = args.progressedPercentage;
    }
    if (args.status !== undefined) {
      this.status = args.status;
    }
    if (args.footerSummary !== undefined) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i202 = 0; _i202 < _size197; ++_i202)
        {
          ...
          for (var _i209 = 0; _i209 < _size204; ++_i209)
          {
            ...
            elem203.push(elem210);
          }
          input.readListEnd();
          this.rows.push(elem203);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TProgressUpdateResp.prototype.write = function(output) {
  ...
  if (this.headerNames !== null && this.headerNames !== undefined) {
    ...
    for (var iter211 in this.headerNames)
    {
      if (this.headerNames.hasOwnProperty(iter211))
      {
        iter211 = this.headerNames[iter211];
  ...
  if (this.rows !== null && this.rows !== undefined) {
    ...
    for (var iter212 in this.rows)
    {
      if (this.rows.hasOwnProperty(iter212))
      {
        iter212 = this.rows[iter212];
...
TGetOperationStatusReq = module.exports.TGetOperationStatusReq = function(args) {
  ...
  if (args) {
    ...
    if (args.getProgressUpdate !== undefined) {
...
TGetOperationStatusResp = module.exports.TGetOperationStatusResp = function(args) {
  ...
  if (args) {
    ...
    if (args.operationStarted !== undefined) {
      this.operationStarted = args.operationStarted;
    }
    if (args.operationCompleted !== undefined) {
      this.operationCompleted = args.operationCompleted;
    }
    if (args.hasResultSet !== undefined) {
      this.hasResultSet = args.hasResultSet;
    }
    if (args.progressUpdateResponse !== undefined) {
      this.progressUpdateResponse = args.progressUpdateResponse;
    }
    if (args.numModifiedRows !== undefined) {
...
TGetQueryIdReq = module.exports.TGetQueryIdReq = function(args) {
  this.operationHandle = null;
  if (args) {
    if (args.operationHandle !== undefined) {
      this.operationHandle = args.operationHandle;
...
TGetQueryIdResp = module.exports.TGetQueryIdResp = function(args) {
  this.queryId = null;
  if (args) {
